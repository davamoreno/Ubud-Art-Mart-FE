      ...
      <div class="bg-white rounded-xl shadow p-6 h-[600px] overflow-y-auto">
        ...
        <div class="grid grid-cols-4 gap-6">
          ...
          >
            ...
            />
            <h2 class="text-base font-semibold text-gray-800">Tas Anyaman</h2>
            <p class="text-sm text-gray-400">Fashion</p>
            <p class="text-sm font-medium text-gray-800 mt-1">Kios Pak Ketut</p>
          </div>
        </div>
      </div>
    </div>
