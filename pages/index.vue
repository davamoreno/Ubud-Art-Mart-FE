      ...
      <div class="absolute top-0 left-0 w-full h-full flex items-center">
        <div class="container mx-auto px-[50px] pt-[113px]">
          <div class="w-2/4 text-white drop-shadow">
            <h1 class="w-3/4 text-3xl font-bold mb-[10px]">{{ $t("dashboard_customer.title") }}</h1>
            <p class="font-medium mb-[32px]">
              Pasar Kesenian Ubud kini hadir secara digital untuk memudahkan anda menjelajahi berbagai produk seni khas
              Bali.
            </p>
  ...
  <div>
    <div class="container mx-auto px-[50px] mt-[120px]">
      ...
      <p class="text-center text-base font-medium mb-[80px] max-w-3xl mx-auto">
        Pasar Seni Ubud (Ubud Art Market) adalah pasar tradisional yang terkenal di Bali, menawarkan berbagai kerajinan
        tangan dan seni khas Bali. Terletak di pusat Ubud, pasar ini menjadi destinasi favorit bagi wisatawan yang
        mencari oleh-oleh unik dan autentik dari Bali.
      </p>
    </div>

    <div class="w-full overflow-x-auto">
      <div class="flex gap-4 mb-4">
        <img src="/assets/images/galery.png" alt="Pasar 1"
          class="rounded-xl w-[700px] h-[350px] object-cover flex-shrink-0" />
        <img src="/assets/images/galery.png" alt="Pasar 2"
          class="rounded-xl w-[700px] h-[350px] object-cover flex-shrink-0" />
        <img src="/assets/images/galery.png" alt="Pasar 3"
          class="rounded-xl w-[700px] h-[350px] object-cover flex-shrink-0" />
        <img src="/assets/images/galery.png" alt="Pasar 4"
          class="rounded-xl w-[700px] h-[350px] object-cover flex-shrink-0" />
      </div>
    </div>
